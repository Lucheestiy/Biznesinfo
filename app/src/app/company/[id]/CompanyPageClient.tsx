...
export default function CompanyPageClient({ id, initialData }: CompanyPageClientProps) {
  ...
  const logoPosition = companyOverride?.logoPosition || "top";
  const showLogo = Boolean(logoOverride || logoUrl) && !logoFailed;
  const showLogoInHeader = showLogo && logoPosition !== "contacts";
  const showLogoInContent = showLogo && logoPosition === "contacts";
  ...
  const headerDescriptionForHeader = headerDescription;
              ...
              <div className="max-w-5xl mx-auto text-center">
                {showLogoInHeader && (
                  <div className="mb-5 flex justify-center">
                    <div className="w-24 h-24 md:w-32 md:h-32 bg-white rounded-xl shadow-lg flex items-center justify-center overflow-hidden">
                      <div className="w-full h-full relative flex items-center justify-center">
        ...
        <div className="container mx-auto py-10 px-4 company-page-content">
          <div className="max-w-4xl mx-auto">
            <div className="space-y-8">
              {/* Logo block for explicit placement below header */}
              {showLogoInContent && (
