    ...
    fetch("/api/biznesinfo/catalog", {
      ...
      .catch((error: unknown) => {
        ...
        if (err?.name !== "AbortError") {
          console.error("Failed to refresh catalog for company counter:", error);
        }
      });
              ...
              <div className="flex flex-wrap justify-center gap-3">
                <div className="relative group/map">
                  ...
                  >
                    ...
                    <span className="group-hover/map:text-yellow-100">{t("home.mapNearby")}</span>
                ...
                <div className="relative group/employee">
                  ...
                  >
                    ...
                    <span className="group-hover/employee:text-yellow-100">{t("home.employeeSearch")}</span>
                  ...
                  <div className="flex-grow text-center md:text-left">
                    <h3 className="text-3xl md:text-4xl font-bold mb-4 group-hover/ai:text-yellow-300 transition-colors duration-300
                      ...
                      <span className="ml-3 text-xs bg-gradient-to-r from-yellow-300 to-yellow-500 text-[#a0006d] px-3 py-1.5 rounded-full font-bold uppercase align-middle
                        shadow-[0_0_15px_rgba(250,204,21,0.5)] animate-pulse">{t("ai.newBadge") || "New"}</span>
                    </h3>
